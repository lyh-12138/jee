...
<body>
	<%!Administator user=new Administator(); %>
	...
	%>
	<form action="/JavaEE_Test/AdministatorServlet?oper=modifyInf" method="post">
	<table>
		<tr><td>姓名:</td><td><input type="text" name="tname" value="<%=user.getAname() %>" disabled="disabled"></td><tr>
		<tr><td>工号:</td><td><input type="text" name="tid" value="<%=user.getAid() %>" disabled="disabled"></td></tr>
