...
<%
	...
	PagedStudentSheet ps = new PagedStudentSheet();
	List<Student> students = ps.getStudentList(start, length);
...
%>
	<table width='80%'>
		<tr style="background-color:lightblue">
			<th>编号</th><th >名字</th><th>年龄</th><th>性别</th><th>出生日期</th><th>学院</th><th>班级</th><th>邮箱</th><th>电话</th>
		</tr>
