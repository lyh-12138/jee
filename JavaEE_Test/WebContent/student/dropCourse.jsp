...
<body>
	...
	<%
		...
		try{
			...
			String sql = "select course.cid,cname,credit,classHour,tname "
							+"from choosecourse,course,teacher "
							+"where choosecourse.cid=course.cid and course.tid=teacher.tid and semester=? and sid=?";
	...
	<form method="post">
		<table>
			<tr style="background-color:lightblue"><th>课程编号</th><th>课程名称</th><th>课程学时</th><th>课程学分</th><th>任课教师</th><th>退课</th>
			...
			<tr>
				...
				<td><input type="submit" value="退课" formaction="/JavaEE_Test/StudentServlet?oper=dropCourse&cid=<%=courselist.get(i).getCid()%>"></td>
			</tr>
				<%} %>
		</table>
	</form>
